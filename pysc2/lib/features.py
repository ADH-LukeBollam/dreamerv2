...
class FeatureUnit(enum.IntEnum):
    ...
    CarryHighYieldMineralFieldMinerals = 53
    CarryMineralFieldMinerals = 54
    ChannelSnipeCombat = 55
    Charging = 56
    ChronoBoostEnergyCost = 57
    CloakFieldEffect = 58
    Contaminated = 59
    EMPDecloak = 60
    FungalGrowth = 61
    ...
    GuardianShield = 63
    ImmortalOverload = 64
    InhibitorZoneTemporalField = 65
    LockOn = 66
    MedivacSpeedBoost = 67
    NeuralParasite = 68
    OracleRevelation = 69
    OracleStasisTrapTarget = 70
    OracleWeapon = 71
    ParasiticBomb = 72
    ParasiticBombSecondaryUnitSearch = 73
    ParasiticBombUnitKU = 74
    PowerUserWarpable = 75
    PsiStorm = 76
    QueenSpawnLarvaTimer = 77
    RavenScramblerMissile = 78
    RavenShredderMissileArmorReduction = 79
    RavenShredderMissileTint = 80
    Slow = 81
    SupplyDrop = 82
    TemporalField = 83
    ViperConsumeStructure = 84
    VoidRaySpeedUpgrade = 85
    VoidRaySwarmDamageBoost = 86
